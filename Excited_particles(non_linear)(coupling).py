...
skew_quad=xt.Multipole(order=1, 
                       knl=None,
                       ksl=[0,0,Ksq],
                       length=Lsq)
...
#SPS_non.append_element(skew_quad, 'skew_quad')
...
excited_arr=non_tracker.record_last_track.state==2
...
plt.figure()
plt.scatter(zeta,delta,label="all particles")
plt.scatter(zeta[excited],delta[excited],label='excited')
...
np.save('cache/excited.npy',excited_arr)
